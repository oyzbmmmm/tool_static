    ...
    var action = {
        ...
        welcome: function () {
            if(document.referrer !== "" && document.referrer.indexOf(current.root) === -1){
                ...
                modules.render(prop.content.welcome || "欢迎来到静谧时光！");
            }
        },
        // 触摸
        touch: function () {
        ...
        buttons: function () {
            ...
            elements.skin.onclick = function () {
                ...
                prop.content.skin && prop.content.skin[1] ? modules.render(prop.content.skin[1]) : modules.render("到我啦~");
            };
            elements.skin.onmouseover = function () {
                prop.content.skin && prop.content.skin[0] ? modules.render(prop.content.skin[0]) : modules.render("想看看我的小伙伴吗？");
            };
            if(prop.model.length > 1) current.menu.appendChild(elements.skin);

            // 关于我
            elements.info.onclick = function () {
                window.open(prop.content.link || "https://www.silencetime.com");
            };
